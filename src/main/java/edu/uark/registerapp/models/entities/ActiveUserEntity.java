// This is how we talk to the DB in the relation useractive
...
@Entity
@Table(name="activeuser")	// In the acitveuser relation
public class ActiveUserEntity {
    @Id
    @Column(name="id", updatable = false) // The id can not be changed
