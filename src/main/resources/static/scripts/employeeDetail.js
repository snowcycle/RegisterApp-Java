...
//task 10 validation of client info
function validateSave() {
	...
	//error display for password if blank
	...
	//error display for employee type
...
//Save employee info and flag it so there's no more editing
